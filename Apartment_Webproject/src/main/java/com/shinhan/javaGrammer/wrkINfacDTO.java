...
public class wrkINfacDTO {
	...
	public String toString() {
		...
		builder.append("아이디:").append(WORKER_ID).append("근로자명:").append(WORKER_NAME).append(" 나이:")
				.append(WORKER_AGE).append(" 성별:").append(WORKER_GENDER).append(" 전화번호:").append(WORKER_PHONE)
