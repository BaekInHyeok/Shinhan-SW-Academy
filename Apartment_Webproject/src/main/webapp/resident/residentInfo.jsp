...
<body>
	<div id="topbar" class="navbar navbar-extends-lg fixed-top bg-primary"
		...
		<div class="container">
			...
			<button type="button" class="btn btn-primary"
				onclick="window.location.href='respage.do'">Resident</button>
			<button type="button" class="btn btn-primary"
	...
	<div id="container">
		...
		<div class="changeListBar">
			<div class="allSearch">
				<button id="btn1" type="button" class="btn btn-primary">입주민
					전체 목록</button>
			</div>
			<div class="selectsearch">
				...
				<button id="btn2" type="button" class="btn btn-info">동별 조회</button>
			</div>
		</div>
					...
					<c:forEach var="res" items="${resList}">
						<tr>
							...
							<td><button id="updatebtn" class="btn btn-info"
									onclick="location.href='resUpdate.do?resid=${res.resident_id}'">수정</button>
							<td><button id="deletebtn" class="btn btn-danger"
									onclick="location.href='resDelete.do?resid=${res.resident_id}'">삭제</button>
						</tr>
					</c:forEach>
				</tbody>
			</table>
