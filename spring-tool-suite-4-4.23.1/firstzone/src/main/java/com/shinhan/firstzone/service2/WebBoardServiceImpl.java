...
public class WebBoardServiceImpl implements WebBoardService{
	...
	public List<WebBoardDTO> getList() {
		...
		List<WebBoardDTO> blist =  boardRepo.findAll().stream().map(en->entityDoDTO(en))
